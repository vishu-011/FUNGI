  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // Additional theme customizations for better consistency
        cardTheme: CardTheme(
          elevation: 0,
          shape: RoundedRectangleBorder(
...
// Updated HomeScreen class with the new design
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Ready to mark your presence today?',
                style: TextStyle(
                  fontSize: 16,
                ...
                children: [
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        // You can add a leaderboard route later
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        // You can add an internal marks route later
                        ScaffoldMessenger.of(context).showSnackBar(
